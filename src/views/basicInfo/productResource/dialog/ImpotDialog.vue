...
export default {
  data() {
    return {
      ...
      dialogVisible: false,
      templateUrl: `${window.globalUrl.HOME_API}agri-web/cd/machine/importTemplate?templateType=productResourcesFile`,
      uploadVisible: false,
      uploadData: {},
      chooseFilelist: [],
      uploadUrl:
