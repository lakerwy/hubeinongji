  ...
  >
    ...
    <div class="content my-form">
      <div>
        ...
        <el-input class="datepicker" readonly v-model="data.plateNumber" style="margin-top:0;" placeholder="请输入农机"></el-input>
        <el-date-picker
          class="datepicker"
        ...
        <el-date-picker
          ...
          @focus="showPanel"
        ></el-date-picker>
        <el-button class="primary-btn-plain" round @click="queryEvent">确定</el-button>
        <!--<a
          class="explortTrack"
          @click="clearEvent"
        >导出</a>-->
...
export default {
  ...
  data() {
    return {
      ...
      TrackPointVisible: true, // 跟踪轨迹点
      TrackPointHide: false, // 隐藏轨迹点
      TrackDirectionVisible: false, // 显示轨迹方向
      playSpeeds: [{ value: 1, label: '1X' }, { value: 2, label: '2X' }, { value: 4, label: '4X' }, { value: 8, label: '8X' }],
      threeDTime: '',
      playSpeed: 1, // 播放速度倍率
  ...
  methods: {
    ...
    async queryEvent() {
      ...
      let params = {
        // machineId: this.data.machineId,
        machineId: '1000000003631',
        beginTime: dateFormat(this.queryStartTime),
        endTime: dateFormat(this.queryEndTime),
      }
